...
| Name                                                                             | Source                                           | Version |
| -------------------------------------------------------------------------------- | ------------------------------------------------ | ------- |
| <a name="module_cloudwatch_logs"></a> [cloudwatch_logs](#module_cloudwatch_logs) | git::github.com/wpartin/terraform-aws-cloudwatch | v0.1.0  |
| <a name="module_kms"></a> [kms](#module_kms)                                     | git::github.com/wpartin/terraform-aws-kms        | v0.1.1  |
...
| --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | :------: |
| <a name="input_cluster_log_types"></a> [cluster_log_types](#input_cluster_log_types)                      | A list of the desired control plane logging types to enable.                            | `list(string)`                                                                                                        | <pre>[<br> "api",<br> "audit"<br>]</pre>                                                              |    no    |
...
| <a name="input_context"></a> [context](#input_context)                                                    | Pass in the appropriate label context module to this variable.                          | `any`                                                                                                                 | n/a                                                                                                   |   yes    |
